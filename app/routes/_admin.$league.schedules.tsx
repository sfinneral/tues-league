...
import { createSchedule, deleteScheduleByDivisionId, getSchedulesByLeagueSlug } from "~/models/schedule.server";
...
export async function action({ request, params }: ActionFunctionArgs) {
    ...
    if (action === 'create') {
        ...
        return createSchedule(divisionId, leagueId, Number(numberOfWeeks), startDate);
    }
                    ...
                    <Flex gap="3" className="my-3 align-middle">
                        ...
                        {!division.schedule ? (
                            <>
                                ...
                                <Button type="submit" name="_action" value="create">generate</Button>
                            </>
                        ) : (<Button color="crimson" name="_action" value="delete" type="submit">delete schedule</Button>)
                        }
